...
export const QUERY_KEYS = {
  ...
  STYLE_SUGGESTIONS: (recipeId: string) => ['beer-styles', 'suggestions', recipeId] as const,
  STYLE_ANALYSIS: (recipeId: string) => ['beer-styles', 'analysis', recipeId] as const,
  
  // Brew Sessions
  BREW_SESSIONS: ['brew-sessions'] as const,
  BREW_SESSION: (id: string) => ['brew-sessions', id] as const,
  FERMENTATION_DATA: (sessionId: string) => ['brew-sessions', sessionId, 'fermentation'] as const,
  FERMENTATION_STATS: (sessionId: string) => ['brew-sessions', sessionId, 'stats'] as const,

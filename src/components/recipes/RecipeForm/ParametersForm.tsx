...
export function ParametersForm({ recipeData, onUpdateField }: ParametersFormProps) {
  ...
  const handleMashTempUnitChange = (unit: 'F' | 'C') => {
    ...
    if (recipeData.mash_temp_unit === 'F' && unit === 'C') {
      newTemp = Math.round(((recipeData.mash_temperature - 32) * 5/9) * 10) / 10;
    } else if (recipeData.mash_temp_unit === 'C' && unit === 'F') {
      newTemp = Math.round((recipeData.mash_temperature * 9/5 + 32) * 10) / 10;
    }
    ...
    <View style={styles.formContainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={[
            styles.textInput,
            errors.boil_time && styles.textInputError,
          ]}
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={[
            styles.textInput,
            errors.efficiency && styles.textInputError,
          ]}
          ...
          <View style={styles.presetsRow}>
            {efficiencyPresets.map((preset) => (
              <TouchableOpacity
                ...
                style={[
                  styles.presetButton,
                  recipeData.efficiency === preset.value && styles.presetButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    ...
                    recipeData.efficiency === preset.value && styles.presetButtonTextActive,
                  ]}
                >
                  {preset.value}%
                </Text>
          ...
          <View style={styles.unitPicker}>
            ...
            >
              <Text
                style={[
                  ...
                  recipeData.mash_temp_unit === 'F' && styles.unitButtonTextActive,
                ]}
              >
                °F
              </Text>
            ...
            >
              <Text
                style={[
                  styles.unitButtonText,
                  recipeData.mash_temp_unit === 'C' && styles.unitButtonTextActive,
                ]}
              >
                °C
              </Text>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          style={[
            styles.textInput,
            errors.mash_time && styles.textInputError,
          ]}
      ...
      <View style={styles.infoSection}>
        ...
        <Text style={styles.infoText}>
          These parameters affect the final recipe calculations. Efficiency is the percentage of 
          potential sugars extracted from grains. Mash temperature affects fermentability and 
